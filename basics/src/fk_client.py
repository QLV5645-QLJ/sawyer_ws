...
def fk_service_client(jointsAngles,limb = "right"):
    ...
    # joints.position = [-0.20288, 0.61753, -1.74399, -1.32579, 1.09791, -1.74968, 0.51062]
    joints.position = list(jointsAngles)
...
def main():
    ...
    while(not fk_service_client(jointsAngles=random_joint_value)):
        random_joint_value = numpy.random.uniform(-pi+1, pi-1, size=(7, ))
        time.sleep(10)
